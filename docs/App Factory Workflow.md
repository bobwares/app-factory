...
| **Location**          | `docs/app-factory-workflow.md`                                                                             |
...
/docs
  ...
  /backend
    ...
    ddd-int-<domain>-integrations-v1.0.md
...
### Example Domain: Customer Maintenance

This workflow is generic, but customer maintenance is a useful example.
...
#### Example Screen Catalog Entries

| Screen ID      | Capability     | Screen Name        | Purpose                                    | Primary Domain Objects     |
| -------------- | -------------- | ------------------ | ------------------------------------------ | -------------------------- |
| `SCR-REG-001`  | `registration` | Registration       | Create a new customer record               | Customer, Address, Consent |
| `SCR-PRO-001`  | `profile`      | Profile Summary    | View and update core profile data          | Customer                   |
| `SCR-ADR-001`  | `addresses`    | Address Management | Add, edit, remove, and validate addresses  | Customer, Address          |
| `SCR-PREF-001` | `preferences`  | Preferences        | Manage communication and usage preferences | Customer, Preference       |
| `SCR-INT-001`  | `integrations` | Integration Links  | View external system links and sync status | Customer, Integration Link |
...
`docs/app-factory-workflow.md`

## Suggested Next Documents

1. `docs/templates/template-glossary-shared.md`
2. `docs/templates/template-ddd-shared.md`
3. `docs/templates/template-prd-be.md`
4. `docs/templates/template-ddd-be.md`
5. `docs/templates/template-prd-fe.md`
6. `docs/templates/template-screen-fe.md`
7. `docs/templates/template-wire-ux.md`
8. `docs/templates/template-dsl-fe.yaml`
9. `docs/templates/template-plan-fullstack.md`
10. `docs/templates/template-trace-fullstack.md`
